      ...
      <div className="p-8 flex-1 flex flex-col gap-10">
        <section>
          <div className="flex items-center gap-2 mb-5 text-zinc-400">
            ...
            {useGameStore(state => state.daysPassed) && (
              <span className="ml-auto text-xs font-mono text-indigo-300/80 bg-indigo-500/10 px-2 py-0.5 rounded-full border border-indigo-500/20">
                第 {useGameStore(state => state.daysPassed)} 天
              </span>
            )}
          </div>
